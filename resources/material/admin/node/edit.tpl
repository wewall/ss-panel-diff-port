							...
							<div class="card-main">
								<div class="card-inner">
                                    ...
                                    <div class="form-group form-group-label" >
                                        ...
                                        <input class="form-control" id="port" type="text" name="port" value="{$node->port}">
                                    </div>
                                    <div class="form-group form-group-label" >
										<label class="floating-label" for="method">加密方式</label>
										<input class="form-control" id="method" type="text" name="method" value="{$node->method}">
									</div>
                                    <div class="form-group form-group-label" >
										<label class="floating-label" for="obfs">混淆</label>
										<input class="form-control" id="obfs" type="text" name="obfs" value="{$node->obfs}">
									</div>
                                    <div class="form-group form-group-label" >
										<label class="floating-label" for="protocol">混淆协议</label>
										<input class="form-control" id="protocol" type="text" name="protocol" value="{$node->protocol}">
									</div>
