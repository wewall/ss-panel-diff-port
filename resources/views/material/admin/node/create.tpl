                        ...
                        <div class="card-main">
                            <div class="card-inner">
								...
								<div class="form-group form-group-label">
                                    ...
                                    <input class="form-control maxwidth-edit" id="obfs" type="text" name="obfs"
                                           value="http_simple">
                                </div>
								<div class="form-group form-group-label">
                                    <label class="floating-label" for="protocol">混淆协议</label>
                                    <input class="form-control maxwidth-edit" id="protocol" name="protocol" type="text" value="auth_aes128_md5">
                                </div>
								<div class="form-group form-group-label">
                                    <label class="floating-label" for="paswd">节点密码</label>
                                    <input class="form-control maxwidth-edit" id="paswd" name="paswd" type="text" value="0">
                                </div>
                                <div class="form-group form-group-label">
        ...
        submitHandler: () => {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    method: $$getValue('port'),
                    method: $$getValue('obfs'),
                    method: $$getValue('protocol'),
                    method: $$getValue('paswd'),
                    custom_method,
                    rate: $$getValue('rate'),
                    info: $$getValue('info'),
                    type,
