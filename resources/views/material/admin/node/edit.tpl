                        ...
                        <div class="card-main">
                            <div class="card-inner">
								...
								<div class="form-group form-group-label">
                                    ...
                                    <input class="form-control maxwidth-edit" id="obfs" name="obfs" type="text" value="{$node->obfs}">
                                </div>
								<div class="form-group form-group-label">
                                    <label class="floating-label" for="protocol">混淆协议</label>
                                    <input class="form-control maxwidth-edit" id="protocol" name="protocol" type="text" value="{$node->protocol}">
                                </div>

								<div class="form-group form-group-label">
                                    <label class="floating-label" for="paswd">节点密码</label>
                                    <input class="form-control maxwidth-edit" id="paswd" name="paswd" type="text" value="{$node->paswd}">
                                </div>
